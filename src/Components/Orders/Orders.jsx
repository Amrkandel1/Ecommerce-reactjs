...
import success from '../../Assets/images/check-7058.svg'
...
export default function Orders() {
  ...
  return <>
    ...
    <h4 className='text-center   border-bottom py-3'> <img width={27} className='mx-3' src={success} alt="" />Payment completed successfully</h4>
